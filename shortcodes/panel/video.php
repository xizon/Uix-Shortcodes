...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Add a Responsive Video', 'uix-shortcodes' ) ); ?>
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?> "[uix_video width='"+uix_sc_video_w+"' height='"+uix_sc_video_h+"' responsive='"+uix_sc_video_responsive+"' url='"+uix_sc_video_url+"']" <?php echo UixShortcodes::send_to_editor_after(); ?>
