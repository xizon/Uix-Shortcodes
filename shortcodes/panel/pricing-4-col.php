...
$form_html .= UixShortcodes::add_form( $form_id, $form_type, $args_4, 'html', __( 'Item 4', 'uix-shortcodes' ) );
...
$form_js .= UixShortcodes::add_form( $form_id, $form_type, $args_4, 'js' );
...
$form_js_vars .= UixShortcodes::add_form( $form_id, $form_type, $args_4, 'js_vars' );
...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Insert Pricing Table (4 column)', 'uix-shortcodes' ) ); ?>
					...
					_vhtml_1 += "<br>[uix_pricing_item target='"+_p_btn_target_1+"' class='"+_p_class_1+"' url='"+uix_sc_pricing_col4_one_btn_link+"' period='"+uix_sc_pricing_col4_one_period+"' bcolor='"+uix_colorTran( uix_sc_pricing_col4_one_btn_color )+"' imcolor='"+uix_sc_pricing_col4_one_emphasis_color+"' col='4']";
					...
					_vhtml_1 += "<br>[uix_pricing_item_detail]"+uix_html_listTran( uix_sc_pricing_col4_one_features, 'ul' )+"[/uix_pricing_item_detail]";					
					_vhtml_1 += "<br>[/uix_pricing_item]<br>";
					
					_vhtml_2 += "[uix_pricing_item target='"+_p_btn_target_2+"' class='"+_p_class_2+"' url='"+uix_sc_pricing_col4_two_btn_link+"' period='"+uix_sc_pricing_col4_two_period+"' bcolor='"+uix_colorTran( uix_sc_pricing_col4_two_btn_color )+"' imcolor='"+uix_sc_pricing_col4_two_emphasis_color+"' col='4']";
					...
					_vhtml_2 += "<br>[uix_pricing_item_detail]"+uix_html_listTran( uix_sc_pricing_col4_two_features, 'ul' )+"[/uix_pricing_item_detail]";					
					_vhtml_2 += "<br>[/uix_pricing_item]<br>";
					
					_vhtml_3 += "[uix_pricing_item target='"+_p_btn_target_3+"' class='"+_p_class_3+"' url='"+uix_sc_pricing_col4_three_btn_link+"' period='"+uix_sc_pricing_col4_three_period+"' bcolor='"+uix_colorTran( uix_sc_pricing_col4_three_btn_color )+"' imcolor='"+uix_sc_pricing_col4_three_emphasis_color+"' col='4']";
					...
					_vhtml_3 += "<br>[uix_pricing_item_detail]"+uix_html_listTran( uix_sc_pricing_col4_three_features, 'ul' )+"[/uix_pricing_item_detail]";					
					_vhtml_3 += "<br>[/uix_pricing_item]<br>";
					
					_vhtml_4 += "[uix_pricing_item target='"+_p_btn_target_4+"' class='"+_p_class_4+"' url='"+uix_sc_pricing_col4_four_btn_link+"' period='"+uix_sc_pricing_col4_four_period+"' bcolor='"+uix_colorTran( uix_sc_pricing_col4_four_btn_color )+"' imcolor='"+uix_sc_pricing_col4_four_emphasis_color+"' col='4' last='1']";
					...
					_vhtml_4 += "<br>[uix_pricing_item_detail]"+uix_html_listTran( uix_sc_pricing_col4_four_features, 'ul' )+"[/uix_pricing_item_detail]";					
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?>"[uix_pricing]" + _vhtml_1 + _vhtml_2 + _vhtml_3 + _vhtml_4 + "[/uix_pricing]" <?php echo UixShortcodes::send_to_editor_after(); ?>
