...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Add a Responsive audio', 'uix-shortcodes' ) ); ?>
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?> "[uix_audio width='"+uix_sc_audio_width+uix_sc_audio_width_units+"' height='"+uix_sc_audio_height+"' soundcloud='"+uix_sc_audio_soundcloud+"' autoplay='"+uix_sc_audio_autoplay+"' loop='"+uix_sc_audio_loop+"' url='"+uix_sc_audio_url+"']" <?php echo UixShortcodes::send_to_editor_after(); ?>
