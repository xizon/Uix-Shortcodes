...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Add Share Buttons', 'uix-shortcodes' ) ); ?>
				...
				window.send_to_editor( "[uix_share_buttons color='"+uix_sc_share_btn_color+"' size='"+uix_sc_share_btn_size+"' fillet='"+uix_sc_share_btn_fillet+"px' show='"+show_checkboxes+"']" );
