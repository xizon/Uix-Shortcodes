...
if ( $sid == -1 && is_admin() ) {
	...
	if( $currentScreen->base === "post" || $currentScreen->base === "widgets" || $currentScreen->base === "customize" || UixSCFormCore::inc_str( $currentScreen->base, '_page_' ) ) {
		...
		UixSCFormCore::reg_clone_vars( 'uix_sc_accordion_list', UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_accordion_listitem_title', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_accordion_listitem_con', $form_html ) );
