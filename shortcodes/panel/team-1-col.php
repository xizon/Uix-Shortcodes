...
( function($) {
	...
	$( document ).ready( function() {
		...
		/* List Item ( step 1) */
		var dynamic_append_box_content = '<?php echo UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_avatar', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_name', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_position', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_intro', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle', $form_html, 'toggle' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_1_url', $form_html, 'toggle-row' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_1_icon', $form_html, 'toggle-row' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_2_url', $form_html, 'toggle-row' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_2_icon', $form_html, 'toggle-row' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_3_url', $form_html, 'toggle-row' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_3_icon', $form_html, 'toggle-row' ); ?>';
