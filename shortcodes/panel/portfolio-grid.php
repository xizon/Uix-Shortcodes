...
( function($) {
	...
	$( document ).ready( function() {
		...
		/* List Item ( step 1) */
		var dynamic_append_box_content = '<?php echo UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_image', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_full_image', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_title', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_type', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_desc', $form_html ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_listitem_toggle', $form_html, 'toggle' ).UixShortcodes::dynamic_form_code( 'dynamic-row-uix_sc_portfolio_grid_url', $form_html, 'toggle-row' ); ?>';
			
		
		
		 /* Callback before custom javascript of sweetalert */
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Insert Portfolio Section', 'uix-shortcodes' ) ); ?>
				...
				for ( var i=0; i<=list_num; i++ ){
					...
					if ( _title != undefined ) {
						show_list_item += "<br>[uix_portfolio_item type='"+uix_htmlencodeToShortcodeFormat( _item_v_type )+"' title='"+uix_htmlencodeToShortcodeFormat( _item_v_title )+"' image='"+_item_v_image+"' fullimage='"+_item_v_imagefull+"' target='"+_item_v_target+"' url='"+_item_url+"']";
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?> "[uix_portfolio filterable='"+_item_v_filterable+"' classprefix='"+uix_sc_portfolio_grid_listitem_class_prefix+"' col='"+uix_sc_portfolio_grid_listitem_col+"' imagefillet='"+uix_sc_portfolio_grid_listitem_image_fillet+"%']"+show_list_item+"<br>[/uix_portfolio]" <?php echo UixShortcodes::send_to_editor_after(); ?>
