...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Insert Tabs', 'uix-shortcodes' ) ); ?>
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?> "[uix_toggle style='"+uix_sc_tabs_style+"' tabs='1' effect='"+uix_sc_tabs_effect+"']"+show_list_tabs+show_list_item+"<br>[/uix_toggle]" <?php echo UixShortcodes::send_to_editor_after(); ?>
