		...
		'use strict';
			$( function() {  
				...
				/*--**************** Custom shortcode begin ****************-- */
					...
					code = "[uix_column_wrapper top='"+uix_sc_col_average_4_padding_top+"' bottom='"+uix_sc_col_average_4_padding_bottom+"' left='"+uix_sc_col_average_4_padding_left+"' right='"+uix_sc_col_average_4_padding_right+"']" + _vhtml + "[/uix_column_wrapper]";
