...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Add a Button', 'uix-shortcodes' ) ); ?>
				...
				<?php echo UixShortcodes::send_to_editor_before( $form_id ); ?> "[uix_button icon='"+uix_sc_btn_icon+"' fontsize='"+uix_sc_btn_fontsize+"px' letterspacing='"+uix_sc_btn_letterspacing+"px' fillet='"+uix_sc_btn_fillet+"px' paddingspacing='"+uix_sc_btn_paddingspacing+"' target='"+uix_sc_btn_result_target+"' bgcolor='"+uix_sc_btn_result_color+"' txtcolor='"+uix_sc_btn_result_txtcolor+"' url='"+uix_sc_btn_result_url+"']"+uix_sc_btn_label+"[/uix_button]" <?php echo UixShortcodes::send_to_editor_after(); ?>
