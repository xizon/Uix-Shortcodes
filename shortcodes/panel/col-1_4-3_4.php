...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Column Three Fourth (last)', 'uix-shortcodes' ) ); ?>
		
	
			
				/* Output */
				_vhtml = '';
				_vhtml += "<br>[uix_column grid='4']Some content for this column.[/uix_column]";
				_vhtml += "<br>[uix_column grid='8' last='1']Some content for this column.[/uix_column]<br>";
				

				window.send_to_editor( "[uix_column_wrapper top='"+uix_sc_col_1_4__3_4_padding_top+"' bottom='"+uix_sc_col_1_4__3_4_padding_bottom+"' left='"+uix_sc_col_1_4__3_4_padding_left+"' right='"+uix_sc_col_1_4__3_4_padding_right+"']" + _vhtml + "[/uix_column_wrapper]" );
