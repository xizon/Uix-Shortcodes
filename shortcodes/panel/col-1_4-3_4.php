...
( function($) {
	...
	$( document ).ready( function() {
		...
		<?php echo UixShortcodes::sweetalert_before( $form_js, $form_html, $form_js_vars, $form_id, __( 'Column Three Fourth (last)', 'uix-shortcodes' ) ); ?>
				...
				<?php echo UixShortcodes::send_to_editor( $form_id ); ?> "[uix_column_wrapper top='"+uix_sc_col_1_4__3_4_padding_top+"' bottom='"+uix_sc_col_1_4__3_4_padding_bottom+"' left='"+uix_sc_col_1_4__3_4_padding_left+"' right='"+uix_sc_col_1_4__3_4_padding_right+"']" + _vhtml + "[/uix_column_wrapper]" );
