...
if ( $sid == -1 && is_admin() ) {
	...
	if( $currentScreen->base === "post" || $currentScreen->base === "widgets" || $currentScreen->base === "customize" || UixSCFormCore::inc_str( $currentScreen->base, '_page_' ) ) {
		...
		UixSCFormCore::reg_clone_vars( 'uix_sc_client_col3_list', UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_client_col3_listitem_logo', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_client_col3_listitem_intro', $form_html ) );
