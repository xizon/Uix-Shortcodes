...
if ( $sid == -1 && is_admin() ) {
	...
	if( $currentScreen->base === "post" || $currentScreen->base === "widgets" || $currentScreen->base === "customize" || self::inc_str( $currentScreen->base, '_page_' ) ) {
		...
		UixSCFormCore::reg_clone_vars( 'uix_sc_team_fullwidth_list', UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_avatar', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_name', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_position', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_intro', $form_html ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle', $form_html, 'toggle' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_1_url', $form_html, 'toggle-row' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_1_icon', $form_html, 'toggle-row' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_2_url', $form_html, 'toggle-row' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_2_icon', $form_html, 'toggle-row' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_3_url', $form_html, 'toggle-row' ).UixSCFormCore::dynamic_form_code( 'dynamic-row-uix_sc_team_fullwidth_listitem_toggle_3_icon', $form_html, 'toggle-row' ) );
		...
		'use strict';
			$( function() { 
				<?php echo UixSCFormCore::uixscform_callback( $form_js, $form_id, __( 'Insert Team Fullwidth', 'uix-shortcodes' ) ); ?>					
