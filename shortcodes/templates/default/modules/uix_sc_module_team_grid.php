 ...
 * ----------------------------------------------------
 */
$clone_trigger_id        = 'uix_sc_team_grid_triggerclonelist';  // String of clone trigger ID, must contain at least "_triggerclonelist"
...
$args = 
	array(
		...
		array(
			'id'             => 'uix_sc_team_grid_config_grid',
		...
		array(
			'id'             => 'uix_sc_team_grid_config_avatar_fillet',
		...
		array(
			'id'             => 'uix_sc_team_grid_config_list_height',
		...
		array(
			'id'             => 'uix_sc_team_grid_config_avatar_gray',
	    ...
	    array(
			'id'             => 'uix_sc_team_grid_config_list_height_tipinfo',
		...
		array(
			...
			array(
				 ...
				 * @template vars: 
				 *
					${uix_sc_team_grid_listitem_name}
					${uix_sc_team_grid_listitem_name_attr}
				 *
				*/
			...
			array(
				 ...
				 * @template vars: 
				 *
					${uix_sc_team_grid_listitem_position}
					${uix_sc_team_grid_listitem_position_attr}
				 *
				*/
			...
			array(
				...
				'toggle'         => array(
										'btn_text'      => esc_html__( 'set up links with toggle', 'uix-shortcodes' ),
		 								'target_ids'    => array( 
																'uix_sc_team_grid_listitem_toggle_url1', 
																'uix_sc_team_grid_listitem_toggle_icon1', 
																'uix_sc_team_grid_listitem_toggle_url2', 
																'uix_sc_team_grid_listitem_toggle_icon2', 
																'uix_sc_team_grid_listitem_toggle_url3', 
																'uix_sc_team_grid_listitem_toggle_icon3' 
															)
									)
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_url1',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_icon1',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_url2',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_icon2',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_url3',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
				...
				array(
					'id'             => 'uix_sc_team_grid_listitem_toggle_icon3',
					'title'          => '',
					'desc'           => '',
					'value'          => '',
...
UixSCFormCore::form_scripts( array(
		'clone'                    => array(
										...
										'fields'         => array( 
																'uix_sc_team_grid_listitem_avatar', 
																'uix_sc_team_grid_listitem_name',
																'uix_sc_team_grid_listitem_position',
																'uix_sc_team_grid_listitem_intro', 
																'uix_sc_team_grid_listitem_toggle',
																'uix_sc_team_grid_listitem_toggle_url1',
																'uix_sc_team_grid_listitem_toggle_icon1', 
																'uix_sc_team_grid_listitem_toggle_url2',
																'uix_sc_team_grid_listitem_toggle_icon2',
	    ...
	    'template'              => '
			...
			[uix_team col=\'${uix_sc_team_grid_config_grid}\' {{if uix_sc_team_grid_config_list_height > 0}}avatarheight=\'${uix_sc_team_grid_config_list_height}px\'{{/if}} avatarfillet=\'${uix_sc_team_grid_config_avatar_fillet}%\' gray=\'{{if uix_sc_team_grid_config_avatar_gray == 1}}true{{else}}false{{/if}}\']

				<!-- loop start -->

					{{each '.$clone_trigger_id.'}}
						{{if uix_sc_team_grid_listitem_name != ""}}

							<br>[uix_team_item col=\'${uix_sc_team_grid_config_grid}\' name=\'${uix_sc_team_grid_listitem_name_attr}\' avatar=\'${uix_sc_team_grid_listitem_avatar}\' position=\'${uix_sc_team_grid_listitem_position_attr}\' social_1=\'${uix_sc_team_grid_listitem_toggle_icon1}|${uix_sc_team_grid_listitem_toggle_url1}\' social_2=\'${uix_sc_team_grid_listitem_toggle_icon2}|${uix_sc_team_grid_listitem_toggle_url2}\' social_3=\'${uix_sc_team_grid_listitem_toggle_icon3}|${uix_sc_team_grid_listitem_toggle_url3}\']
							<br>[uix_team_item_desc]${uix_sc_team_grid_listitem_intro}[/uix_team_item_desc]					
							<br>[/uix_team_item]
