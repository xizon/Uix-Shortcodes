...
$args = 
	array(
	    ...
	    array(
		     ...
		     * @template vars: 
			 *
				${uix_sc_col_1_4__3_4_padding_top}
				${uix_sc_col_1_4__3_4_padding_right}
				${uix_sc_col_1_4__3_4_padding_bottom}
				${uix_sc_col_1_4__3_4_padding_left}
			 *
			*/
...
UixSCFormCore::form_scripts( array(
	    ...
	    'template'              => '
			...
			[uix_column_wrapper top=\'${uix_sc_col_1_4__3_4_padding_top}\' bottom=\'${uix_sc_col_1_4__3_4_padding_bottom}\' left=\'${uix_sc_col_1_4__3_4_padding_left}\' right=\'${uix_sc_col_1_4__3_4_padding_right}\']
				<br>[uix_column grid=\'4\']<p>'.esc_html__( 'Some content for this column.', 'uix-shortcodes' ).'</p>[/uix_column]
				<br>[uix_column grid=\'8\' last=\'1\']<p>'.esc_html__( 'Some content for this column.', 'uix-shortcodes' ).'</p>[/uix_column]<br>
			[/uix_column_wrapper]
