 ...
 * ----------------------------------------------------
 */
$clone_trigger_id        = 'uix_sc_features_col3_triggerclonelist';  // String of clone trigger ID, must contain at least "_triggerclonelist"
...
UixSCFormCore::form_scripts( array(
		'clone'                    => array(
										...
										'fields'         => array( 
																'uix_sc_features_col3_listitem_title', 
																'uix_sc_features_col3_listitem_desc',
																'uix_sc_features_col3_listitem_icon',
															)
									),
		'form_id'                 => $form_id,
		'fields'                  => array(
	    ...
	    'template'              => '
			...
			<!-- loop start -->
				...
				{{each '.$clone_trigger_id.'}}
					<br>[uix_features_item col=\'3\' icon=\'{{if uix_sc_features_col3_listitem_icon != ""}}${uix_sc_features_col3_listitem_icon}{{/if}}\'  {{if ($index+1) >=3 && ($index+1) % 3 == 0}}last=\'1\'{{/if}}]
					<br>[uix_features_item_title]${uix_sc_features_col3_listitem_title}[/uix_features_item_title]			
					<br>[uix_features_item_desc]${uix_sc_features_col3_listitem_desc}[/uix_features_item_desc]					
