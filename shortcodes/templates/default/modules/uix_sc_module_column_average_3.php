...
$args = 
	array(
	    ...
	    array(
		     ...
		     * @template vars: 
			 *
				${uix_sc_col_average_3_padding_top}
				${uix_sc_col_average_3_padding_right}
				${uix_sc_col_average_3_padding_bottom}
				${uix_sc_col_average_3_padding_left}
			 *
			*/
...
UixSCFormCore::form_scripts( array(
	    ...
	    'template'              => '
			...
			[uix_column_wrapper top=\'${uix_sc_col_average_3_padding_top}\' bottom=\'${uix_sc_col_average_3_padding_bottom}\' left=\'${uix_sc_col_average_3_padding_left}\' right=\'${uix_sc_col_average_3_padding_right}\']
