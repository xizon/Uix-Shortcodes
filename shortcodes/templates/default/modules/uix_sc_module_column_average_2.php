...
$args = 
	array(
	    ...
	    array(
		     ...
		     * @template vars: 
			 *
				${uix_sc_col_average_2_padding_top}
				${uix_sc_col_average_2_padding_right}
				${uix_sc_col_average_2_padding_bottom}
				${uix_sc_col_average_2_padding_left}
			 *
			*/
...
UixSCFormCore::form_scripts( array(
		...
		'title'                   => esc_html__( 'Column One Half', 'uix-shortcodes' ),
	    ...
	    'template'              => '
			...
			[uix_column_wrapper top=\'${uix_sc_col_average_2_padding_top}\' bottom=\'${uix_sc_col_average_2_padding_bottom}\' left=\'${uix_sc_col_average_2_padding_left}\' right=\'${uix_sc_col_average_2_padding_right}\']
				<br>[uix_column grid=\'6\']<p>'.esc_html__( 'Some content for this column.', 'uix-shortcodes' ).'</p>[/uix_column]
				<br>[uix_column grid=\'6\' last=\'1\']<p>'.esc_html__( 'Some content for this column.', 'uix-shortcodes' ).'</p>[/uix_column]<br>
			[/uix_column_wrapper]
