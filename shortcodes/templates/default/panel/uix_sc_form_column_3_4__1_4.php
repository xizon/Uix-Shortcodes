 ...
 * ----------------------------------------------------
 */
$form_vars = UixShortcodes::init_template_parameters( 'uix_sc_form_column_3_4__1_4' );
...
UixShortcodes::form_scripts( array(
	    ...
	    'js_template'             => '
			...
			/* Output */
			_vhtml = \'\';
			_vhtml += "<br>[uix_column grid=\'8\']<p>'.esc_html__( 'Some content for this column.', 'uix-shortcodes' ).'</p>[/uix_column]";
