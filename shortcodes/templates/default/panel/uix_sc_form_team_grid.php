 ...
 * ----------------------------------------------------
 */
$form_vars = UixShortcodes::init_template_parameters( 'uix_sc_form_team_grid' );
 ...
 */
//clone list
$clone_trigger_id = 'uix_sc_team_grid_list';   // ID of clone trigger 
	    ...
	    'clone'                   => array(
										...
										'fields_group'  => array(
																array(
																	...
																	'fields'         => array( 'uix_sc_team_grid_listitem_avatar', 'uix_sc_team_grid_listitem_name', 'uix_sc_team_grid_listitem_position', 'uix_sc_team_grid_listitem_intro', 'uix_sc_team_grid_listitem_toggle', 'uix_sc_team_grid_listitem_toggle_1_url', 'uix_sc_team_grid_listitem_toggle_1_icon', 'uix_sc_team_grid_listitem_toggle_2_url', 'uix_sc_team_grid_listitem_toggle_2_icon', 'uix_sc_team_grid_listitem_toggle_3_url', 'uix_sc_team_grid_listitem_toggle_3_icon' )
																),
															)
									),
		'form_id'                 => $form_id,
