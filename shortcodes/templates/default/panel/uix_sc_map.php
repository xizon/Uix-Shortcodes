...
$args = 
	array(
	    ...
	    array(
			...
			'desc'           => wp_kses( sprintf( __( 'You can make a search, use the name of a place, city, state, or address, or click the location on the map to get lat long coordinates. &rarr; <a href="%1$s" target="_blank" rel="nofollow">Get Latitude Longitude</a>', 'uix-shortcodes' ), '//www.latlong.net' ), wp_kses_allowed_html( 'post' ) ),
			'value'          => 'normal',
			'placeholder'    => '',
			'type'           => 'radio-image',
			'default'        => array(
