...
class UixSCFormType_Editor {
	...
	public static function add( $args, $_output ) {
		...
		if ( $type == 'editor' ) {
			...
			$editor_contents = str_replace( 'id="'.$id.'"', 'id="'.$id.'" placeholder="'.$placeholder.'"', $editor_contents );
			...
			$field = '
					<tr'.$class.'>
						...
						<td>	
							...
							<div class="uixscform-box uixscform-mce-editor">
							...
							'.( !empty( $id ) ? '<textarea style="display:none;" id="'.$id.'" name="'.$name.'">'.$value.'</textarea>' : '' ).' 	
						</td>
					</tr> 
				'.PHP_EOL;	
