...
Get an API Key?</a> If left blank, the default Key will be used, but it will have a traffic excess problem that will not display properly.', 'uix-shortcodes' ), esc_url( '//developers.google.com/maps/documentation/javascript/get-api-key' ) );   
				   ?>
				</p>
