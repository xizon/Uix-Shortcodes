<?php
class UixSCFormType_Toggle extends UixSCFormCore {
                    ...
                    <tr'.$class.'>
                        ...
                        <td>
						   ...
						   <div class="uixscform-box">
								<a data-trigger-clone="0" href="javascript:" class="'.$link_class.' '.( $link_class == 'table-link-icon' ? 'table-link-iconattr' : '' ).' uixscform_btn_trigger-toggleshow" data-targetid="'.$target_id.'" title="'.esc_attr( $btn_text ).'">'.( $link_class == 'table-link-icon' ? '<i class="fa fa-sort-desc"></i>'.__( 'More Options', 'uix-shortcodes' ) : $btn_text ).'</a>
