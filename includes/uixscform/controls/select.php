<?php
class UixSCFormType_Select extends UixSCFormCore {
                    ...
                    <tr'.$class.'>
                        ...
                        <td>	
						   <div class="uixscform-box">	
                              ...
                              <select class="uixscform-normal uixscform_btn_trigger-select" data-targetid="${'.$id.'__fieldID}">'.$optionlist.'</select>
