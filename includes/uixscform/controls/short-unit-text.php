<?php
class UixSCFormType_ShortUnitsText extends UixSCFormCore {
                        ...
                        <td>
						    ...
						    <div class="uixscform-box">
								...
								<div class="uixscform-input-text-short">
								   ...
								   <input '.$callback.' type="text" id="${'.$id.'__fieldID}" name="${'.$id.'__fieldID}" class="uixscform-normal uixscform-input-text" data-enter-value="true" value="{{if '.$id.'__fieldVal}}${'.$id.'__fieldVal}{{else}}'.$value.'{{/if}}" placeholder="'.$placeholder.'">
								   
								   
								   <span class="units units-short units-selector uixscform_btn_trigger-radio" data-targetid="${'.$id.'_units__fieldID}">'.$unitslist.'</span>
