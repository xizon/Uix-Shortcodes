			...
			$( document ).off( 'click.UIXSC_FORMPOP_INSERT' ).on( 'click.UIXSC_FORMPOP_INSERT mouseenter.UIXSC_FORMPOP_INSERT', '.uixscform-modal-save-btn', function( e ) {
				...
				if ( curSaveBtn.length == 1 ) {
					...
					if ( e.type == 'click' ) {
						...
						if ( $( 'textarea[data-block-id="'+$obj.data( 'block-id' )+'"]' ).length > 0 ) {
							$( 'textarea[data-block-id="'+$obj.data( 'block-id' )+'"]' ).attr( {
								'data-block-value' : uixscform_insertToBlockTextarea( $previewBtn.data( 'code' ) )
							} );	
							$( 'textarea[data-block-id="'+$obj.data( 'block-id' )+'"]' ).val( uixscform_insertToBlockTextarea( $previewBtn.data( 'code' ) ) );	
						}
